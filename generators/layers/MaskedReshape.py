...
class MaskedReshapeLayer(MergeLayer):
    ...
    def __init__(self, incoming, input_mask, shape,
        ...
        if not isinstance(input_mask, Layer):
            ...
            input_mask = InputLayer(input_mask_shape,
                                    input_var=input_mask,
                                    name="input_mask inputlayer")
...
class UnmaskedReshapeLayer(MergeLayer):
    ...
    def __init__(self, incoming, input_unmask, shape,
        ...
        if not isinstance(input_unmask, Layer):
            ...
            input_unmask = InputLayer(input_unmask_shape,
                                      input_var=input_unmask,
                                      name="input_unmask inputlayer")
    ...
    def get_output_for(self, inputs, **kwargs):
        ...
        out = T.set_subtensor(out[input_unmask.nonzero()],
                              input_.reshape(shape=data_shape))
