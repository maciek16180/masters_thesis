...
if not use_negative_examples:
    ...
    data_pos = np.load(squad_path + 'train_pos_with_glove_vocab.pkl')
    data_neg = np.load(squad_path + 'train_neg_with_glove_vocab.pkl')
...
net = QANet.QANet(voc_size=voc_size,
                  ...
                  train_inds=[400001],
                  emb_dropout=True,
                  working_path='../evaluate/glove_vocab/training/',
                  eval_path='../evaluate/')

model_filename = '../trained_models/glove_vocab/wiki_negative/charemb_trainNAW_dropout/charemb_trainNAW_dropout'
